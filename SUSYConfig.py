...
Observables = {
    ...
    'cosCb_BA':      {'range': [-1, 1]},
    'cosCb_BB':      {'range': [-1, 1]},
    'dphi_PP_Pa_AA': {'range': [0, 2.*np.pi]},
    'dphi_PP_Pa_BB': {'range': [0, 2.*np.pi]},
    'dphi_PP_Pa_AB': {'range': [0, 2.*np.pi]},
    'dphi_PP_Pa_BA': {'range': [0, 2.*np.pi]},
    'dphi_PP_Pb_AA': {'range': [0, 2.*np.pi]},
    'dphi_PP_Pb_BB': {'range': [0, 2.*np.pi]},
    'dphi_PP_Pb_AB': {'range': [0, 2.*np.pi]},
    'dphi_PP_Pb_BA': {'range': [0, 2.*np.pi]},
    'dphi_Pa_Ca_AA': {'range': [0, 2.*np.pi]},
    'dphi_Pa_Ca_BB': {'range': [0, 2.*np.pi]},
    'dphi_Pa_Ca_AB': {'range': [0, 2.*np.pi]},
    'dphi_Pa_Ca_BA': {'range': [0, 2.*np.pi]},
    'dphi_Pb_Cb_AA': {'range': [0, 2.*np.pi]},
    'dphi_Pb_Cb_BB': {'range': [0, 2.*np.pi]},
    'dphi_Pb_Cb_AB': {'range': [0, 2.*np.pi]},
    'dphi_Pb_Cb_BA': {'range': [0, 2.*np.pi]},
    }
...
SelectedFields = [
    ...
    # recursive jigsaw reconstruction, just mass/energy
    ...
    # single topologic reconstruction
    ['MPP_AA', 'Eb_a_AA', 'Eb_b_AA', 'El_a_AA', 'El_b_AA',
